...
{
 public class LeecherVideoQuality : IComparable<LeecherVideoQuality>
 {
        #region კონსტანტები
        ...
        public  LeecherVideoQuality(string qualityId, string resolution = null, string fps = null)
        {
        ...
        public int  CompareTo(LeecherVideoQuality  other)
        {
            if (other == null)
            {
                return -1;
