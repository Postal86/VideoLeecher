...
namespace VideoLeecher.core.Models
{
    public class TwitchVideo
    {
        ...
        private IList<TwitchVideoQuality> _qualities;
        ...
        public TwitchVideo(string channel, string title, string id, string game, int views, TimeSpan length, IList<TwitchVideoQuality> qualities, DateTime recordedDate,
        ...
        public  IList<TwitchVideoQuality>  Qualities
        {
            get
            {
                return _qualities;
