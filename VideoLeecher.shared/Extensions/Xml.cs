...
namespace VideoLeecher.shared.Extensions
{
    public static class XmlExtensions
    {
        ...
        #region XElement გეთერების მნიშვნელობა
        ...
        public  static Uri  GetValueAsAbsoluteUri(this XElement xel, bool nullAllowed = false)
        {
            ...
            if (Uri.TryCreate(valueStr, UriKind.Absolute, out Uri uri))
            {
                return uri;
            }
            else
        ...
        #endregion  XElement გეთერების მნიშვნელობა

        #region XAttribute

        #region XAttribute  გეთერების მნიშვნელობა
        ...
        #endregion XAttribute  გეთერების მნიშვნელობა

        #region პირადი_ჰელფერები
