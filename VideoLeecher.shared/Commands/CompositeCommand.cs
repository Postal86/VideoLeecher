...
namespace VideoLeecher.shared.Commands
{
    public class CompositeCommand : ICommand
    {
        ...
        private readonly EventHandler onRegisteredCommandCanExecuteChangeHandler;

        public CompositeCommand()
        {
            onRegisteredCommandCanExecuteChangeHandler = new EventHandler(OnRegisteredCommandCanExecuteChanged);
        }
        ...
        public virtual void RegisterCommand(ICommand command)
        {
            ...
            if (command == this)
            {
                throw new ArgumentNullException("Cannot register a  CompositeCommand in itself"); 
            }
            ...
            command.CanExecuteChanged += onRegisteredCommandCanExecuteChangeHandler;
            OnCanExecuteChanged();
        ...
        public ICollection<ICommand> RegisteredCommands
        {
             get
            {
                ICollection<ICommand> commandList;
                lock (registeredCommands)
                {
